                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown {{ Request::is('buildfeed*') || Request::is('viv*') ? 'active' : '' }}">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="https://medium.com/changewindows" target="_blank"><i class="fab text-primary fa-fw fa-medium-m"></i> Blog</a>
                                <a class="dropdown-item" href="{{ route('viv') }}"><i class="fad text-primary fa-fw fa-alicorn"></i> About</a>
                                <a class="dropdown-item" href="{{ route('buildfeed') }}"><i class="fad text-primary fa-fw fa-rss"></i> BuildFeed</a>
                                <div class="dropdown-divider"></div>
                                <h6 class="dropdown-header">RSS</h6>
                                <a class="dropdown-item" href="/feed"><i class="fad text-primary fa-fw fa-rss-square"></i> Flight feed</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="https://github.com/ChangeWindows/Viv/"><i class="fab text-primary fa-fw fa-github"></i> GitHub</a>
                                <a class="dropdown-item" href="https://twitter.com/changewindows"><i class="fab text-primary fa-fw fa-twitter"></i> @ChangeWindows</a>
                                <a class="dropdown-item" href="https://patreon.com/changewindows"><i class="fab text-primary fa-fw fa-patreon"></i> Patreon</a>
                            </div>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        @auth
                            <li class="nav-item dropdown {{ Request::is('profile') || Request::is('register') || Request::is('login') || Request::is('password*') ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fad text-primary fa-fw fa-user-circle d-inline"></i><span class="d-none d-md-inline"> {{ Auth::user()->name }}<span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->hasAnyRole(['Admin']))
                                        @yield('toolset')
                                        <a class="dropdown-item" href="{{ route('showFlights') }}"><i class="fad text-primary fa-fw fa-plane"></i> Flights</a>
                                        <a class="dropdown-item" href="{{ route('showChangelogs') }}"><i class="fad text-primary fa-fw fa-align-left"></i> Changelogs</a>
                                        <a class="dropdown-item" href="{{ route('showUsers') }}"><i class="fad text-primary fa-fw fa-users"></i> Users</a>
                                        <a class="dropdown-item" href="{{ route('showPatreon') }}"><i class="fab text-primary fa-fw fa-patreon"></i> Patrons</a>
                                        <div class="dropdown-divider"></div>
                                    @endif
                                    <a class="dropdown-item" href="{{ route('profile') }}"><i class="fad text-primary fa-fw fa-cog"></i> Settings</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fad text-primary fa-fw fa-sign-out"></i> Log out</a>
                        ...
                        @else
                            <li class="nav-item nav-login {{ Request::is('register') || Request::is('login') || Request::is('password*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('login') }}"><i class="fad text-primary fa-fw fa-sign-in d-inline"></i><span class="d-none d-sm-inline"> Login<span></a>
                            </li>
                        @endauth
                    </ul>
                </div>
