...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('js/bootstrap.bundle.min.js?v6.0-alpha.2') }}" defer></script>
        <script src="{{ asset('js/app.js?v6.0-alpha.2') }}" defer></script>
        <link href="{{ asset('css/app.css?v6.0-alpha.2') }}" rel="stylesheet">
        <script src="{{ asset('js/brands.min.js?v6.0-alpha.2') }}" defer></script>
        <script src="{{ asset('js/regular.min.js?v6.0-alpha.2') }}" defer></script>
        <script src="{{ asset('js/fontawesome.min.js?v6.0-alpha.2') }}" defer></script>
                ...
                <div class="content">
                    <div class="row mt-4 mb-4">
                        <div class="col-6">
                            ...
                            <p class="mb-0"><a href="{{ route('vivChangelog') }}">{{ config('app.viv') }}</a> &middot; 2014-2021 &copy; <a href="https://studio384.be">Studio 384</a></p>
                        </div>
