...
<form method="POST" action="{{ route('updateMilestone', $milestone->id) }}" class="row">
    ...
    <div class="col-lg-4 col-md-6 col-sm">
        ...
        <div class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" id="pcFast" name="pcFast" {{ $milestone->pcFast == '1' ? 'checked' : '' }} value="2"><label class="custom-control-label" for="pcFast"><span class="label fast">Dev</span></label></label></div>
        <div class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" id="pcSlow" name="pcSlow" {{ $milestone->pcSlow == '1' ? 'checked' : '' }} value="3"><label class="custom-control-label" for="pcSlow"><span class="label slow">Beta</span></label></label></div>
