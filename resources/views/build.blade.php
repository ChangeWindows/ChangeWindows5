...
<div class="row">
    ...
    <div class="col-lg-3">
        <div class="row row-btn">
            @if ($previous)
                <a class="col btn btn-lg btn-primary btn-block" href="{{ route('showRelease', ['build' => $previous->build]) }}"><i class="fad fa-fw fa-angle-left"></i> {{ $previous->build }}</a>
            @endif
            @if ($next)
                <a class="col btn btn-lg btn-primary btn-block" href="{{ route('showRelease', ['build' => $next->build]) }}">{{ $next->build }} <i class="fad fa-fw fa-angle-right"></i></a>
            @endif
        </div>
