        ...
        <div class="col-12">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0">&copy; Studio 384 &middot; 2014-2021</p>
        ...
        <div class="col-12" id="new">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <section>
                        <h5 class="mt-3">What's new in ChangeWindows 6.0-alpha.3? <small class="text-muted">11 January 2021</small></h5>
                        <p><i class="fab fa-fw fa-laravel"></i> Laravel 8.21.1 &middot; <i class="fab fa-fw fa-bootstrap"></i> Bootstrap 5.0.0-alpha3 &middot; <i class="fab fa-fw fa-font-awesome"></i> Font Awesome 5.15.1</p>
                        ...
                        <ul>
                            ...
                            <li>Channels can now be marked as inactive or active by milestone on top of existing or not existing.</li>
                        </ul>
                    </section>
                    <section>
