...
<div class="row">
    <div class="col">
        <h1 class="title m-b-md">Welcome to <span class="font-uppercase font-light">Change</span><span class="font-uppercase font-bold">Windows</span></h1>
        <h5>Version 5.0 Preview</h5>
        ...
        <h2>Disclaimer</h2>
        <p>hangeWindows and studio384 are not related to Microsoft in any way. All trademarks mentioned are the property of their respective owners. We do not guarantee the correctness of the information on this site.</p>
    </div>
</div>
@endsection