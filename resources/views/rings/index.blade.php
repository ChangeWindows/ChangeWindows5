...
<div class="row px-n10 rings">
    <div class="col-12" id="pc">
        ...
        <div class="row row-gutter">
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['skip'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['fast'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['slow'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['release'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['targeted'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['pc']['ltsc'] ) ?></div>
        </div>
    </div>
    <div class="col-12" id="xbox">
        <p class="h3"><i class="fab fa-fw fa-xbox"></i> Xbox</p>
        <div class="row row-gutter">
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['skip'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['fast'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['slow'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['preview'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['release'] ) ?></div>
            <div class="col-xl col-md-4 col-6"><?php getTile( $flights['xbox']['targeted'] ) ?></div>
        </div>
    </div>
    ...
    <div class="col-12" id="holographic">
        ...
        <div class="row row-gutter">
            <div class="col-md col-6"><?php getTile( $flights['holo']['fast'] ) ?></div>
            <div class="col-md col-6"><?php getTile( $flights['holo']['slow'] ) ?></div>
            <div class="col-md col-6"><?php getTile( $flights['holo']['targeted'] ) ?></div>
            <div class="col-md col-6"><?php getTile( $flights['holo']['ltsc'] ) ?></div>
        </div>
    </div>
    <div class="col-12" id="team">
        <p class="h3"><i class="fab fa-fw fa-windows"></i> Team</p>
        <div class="row row-gutter">
            <div class="col-xl col-sm-4 col-6"><?php getTile( $flights['team']['fast'] ) ?></div>
            <div class="col-xl col-sm-4 col-6"><?php getTile( $flights['team']['slow'] ) ?></div>
            <div class="col-xl col-sm-4 col-12"><?php getTile( $flights['team']['targeted'] ) ?></div>
        </div>
    </div>
